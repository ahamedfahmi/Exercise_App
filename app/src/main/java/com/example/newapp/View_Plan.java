    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        floatingActionButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(View_Plan.this , Create_Plan.class);
        ...
        dbHelper = new DBHelper(View_Plan.this);
        id = new ArrayList<>();
        title = new ArrayList<>();
        color = new ArrayList<>();
        ...
        customAdapter = new CustomAdapter(View_Plan.this , id , title ,color);
